...
_EPISODE = 'Record067/Camera 6'
_SAVE_DIR = '/media/luo/Dataset/RnnFusion/apollo_data'
_SAMPLE_NUM = 60000
_START_INDEX = 0
_FRAME_NUMBER = 595
...
def main(unused_argv):
    ...
    pcl_p_prefix = join(Save_path, 'infer')
    ...
    for pred_dict, image_path in zip(predictions, image_files):
        ...
        extrincs = decode_extrincs(path.split('.')[0], join(Save_path, 'pose'))
