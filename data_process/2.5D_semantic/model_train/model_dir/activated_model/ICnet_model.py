...
from model_dir.model_lib.ICNET_model.ICNET_model import ICNet_BN
...
def ICNet_model(input, is_training, num_classes, batch_norm_decay = 0.997, pretrian_model = None):
    image = input
    ...
    with tf.name_scope('load_pretrain'):
        global _LOAD_PRETRAINED
        if not _LOAD_PRETRAINED and is_training and pretrian_model:
            ...
            tf.train.init_from_checkpoint(pretrian_model,
