...
BATCH_SIZE = 32
#这里用来修改可视化的中心坐标以及范围
visionlize_center = [-12142.5, 3300.5, 40]
...
if __name__ == '__main__':
    if VISUALIZE_STF:
        ...
        model_path = root_path + 'train/feature/runs/SPNET/158000/158000newdata_model.pkl'
        save_path = root_path + 'train/feature/runs/SPNET/158000/'
